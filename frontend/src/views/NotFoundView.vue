...
<template>
  <div class="bg-zinc-800 h-screen w-full  justify-center ">
    <center class="mt-24 m-auto">
      ...
      <div class=" tracking-widest mt-4">
        <span class="text-teal-500 text-6xl block"><span>4  0  4</span></span>
        <span class="text-teal-500 text-xl">Sorry, We couldn't find what you are looking for!</span>
      </div>
    </center>
    <center class="mt-6">
      <button @click="goBack" class="text-teal-500 font-mono text-xl bg-zinc-700 shadow-s shadow-zinc-900 p-3 rounded-md hover:shadow-xl hover:shadow-zinc-900 duration-150 transition-shadow ease-linear">Volver Atrás </button>
    </center>
  </div>
</template>
